...
import { cargarPersonaje, actualizarAnimacion } from './personaje.js';
...
function iniciarPasillo() {
    ...
    cargarPersonaje(escena); // ⬅️ Esto es lo que falta
...
//         }
    ...
    function animar() {
        ...
        const delta = reloj.getDelta(); // ⬅️ AGREGAR ESTA LÍNEA
        actualizarAnimacion(delta);     // ⬅️ Y ESTA LÍNEA
